...
%						\bf interpretation: \rm YES OR NO - ARE WE IMPRESSED? :)
 ...
 \newpage	
	\section{Conclusion}
		The Visualizer built for our project is currently available at \url{http://cedricwaldburger.ch/comp621u/main.html} and will be removed by the end of the semester. The code itself can be pulled from Github on this address \url{https://github.com/Hirschen/comp621u}.
